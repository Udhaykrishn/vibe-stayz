...
export const cms: Record<string, Config> = {
    ...
    groups: [
      {
        ...
        fields: [
          ...
          f("icon", "Navigation icon", "select", {
            options: ["mountain", "trees", "waves", "leaf", "pin"],
          }),
        ],
      },
      photo,
  ...
  offers: {
    ...
    singular: "Offer",
    icon: "offer",
    description: "Promotional escape ideas, without a checkout.",
    groups: [
      {
        title: "Offer",
        fields: [
  ...
  testimonials: {
    ...
    icon: "star",
    description: "Publish genuine feedback from your guests.",
    groups: [
      {
        title: "Guest story",
        fields: [
          f("name", "Guest name", "text", { required: true }),
          f("location", "Guest location"),
          f("rating", "Rating (1–5)", "number", { required: true }),
          f("quote", "Testimonial", "textarea", { required: true, full: true }),
          f("photo", "Guest photo", "image"),
          f("resort_id", "Resort visited", "select", { relation: "resorts" }),
          f("published", "Published", "checkbox"),
          f("display_order", "Display order", "number"),
          f("is_demo", "Sample story", "checkbox"),
        ],
      },
    ],
  },
  ...
  page_content: {
    ...
    icon: "file",
    description: "Shape your story without touching the code.",
    groups: [
      {
        title: "Page section",
        fields: [
      ...
      seo,
      {
        ...
        fields: [
          ...
          f("show_demo", "Show sample collection", "checkbox", {
            help: "Turn off before launch. Hides sample properties, locations, offers and stories, and removes preview noindex.",
          }),
        ],
      },
    ],
